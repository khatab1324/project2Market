...
export const BackgroundCircles = () => {
  ...
  return (
    <div className="absolute -top-[42.375rem]  right-96 aspect-square border border-n-2/5 rounded-full -translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem]">
      <Rings />

      {/* Moving background colored circle balls */}

      <div className="absolute z-40 bottom-1/2  left-1/2 w-0.25 h-1/2 origin-bottom rotate-[46deg]">
        <div
      ...
      <div className="absolute z-40 bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom -rotate-[56deg]">
        <div
      ...
      <div className="absolute z-40 bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom rotate-[54deg]">
        <div
      ...
      <div className="absolute z-40 bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom -rotate-[65deg]">
        <div
