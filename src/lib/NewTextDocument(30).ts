...
import albara from "../assets/drImg/albara.jpg";
...
export const majors = [
  { id: "ai", title: "AI /IT" },
  { id: "researshers", title: "Researshers" },
  { id: "science", title: "Engineer/science" },
];
...
export const winnersSessonOne = {
  ...
  It: {
    ...
    data: [
      {
        id: "1",
        projectTitle: "An innovative approach for the control of insects in mites",
        projectDescription:
          "we are the best compatition in jordan and we are aim to univarsity student",
        particepentsNames: [],
        place: 1,
      ...
      {
        id: "3",
        projectTitle: "The impact of the accounting experience of the board of directors on the dividend distribution policy",
        projectDescription:
          "we are the best compatition in jordan and we are aim to univarsity student",
        particepentsNames: [],
        place: 3,
